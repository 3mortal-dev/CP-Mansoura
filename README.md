...
└── Number-Theory/
    ...
    │   ├── A_Almost_Prime.cpp
    │   ├── B_T_primes.cpp
    │   ├── D_Is_it_Prime_hard_version.cpp
    │   └── Divisor_Summation.cpp
    └── Sheet/
        ├── A_Almost_Prime.cpp
        ├── B_Is_it_Prime_easy_version.cpp
        ├── C_Dice_Roll_Sequence.cpp
        ├── D_Is_it_Prime_hard_version.cpp
        ├── D_Remove_Two_Letters.cpp
        ├── Divisor_Summation.cpp
        ├── E_Project_Euler_7_10001_st_prime.cpp
        ├── F_Printing_some_primes.cpp
        ├── G_Prime_factorization_hard_version.cpp
        ├── H_Prime_Frequency.cpp
        ├── J_Psycho.cpp
        ├── K_Noldbach_problem.cpp
        ├── L_Odd_Divisor.cpp
        ├── M_Beautiful_Divisors.cpp
        ├── N_T_primes.cpp
        ├── O_Sherlock_and_his_girlfriend.cpp
        ├── Q_Prime_Matrix.cpp
        ├── R_Chef_and_Semi_Primes.cpp
        ├── T_Easy_Number_Challenge.cpp
        ├── U_Win_or_Freeze.cpp
        ├── V_Summation_of_Four_Primes.cpp
        └── W_Factorial_Factors.cpp
```

## Links

[Roadmap](https://roadmap.sh/r/problem-solving-u8am0)
...
- **[C/C++ Snippets](https://marketplace.visualstudio.com/items?itemName=tahabasri.snippets)** - For code templates (you can import my snippets from `/snippets/3mortal-snippets.json`)
...
- Solutions are for learning. Try solving independently first!
- These are my own solutions
- In the future, I'm intending to add more comments and clarifications to each problem

---

**Media:** [@3mortal-dev](https://github.com/3mortal-dev) | [@3mortal](https://www.linkedin.com/in/amar-ayman-774518251/)
